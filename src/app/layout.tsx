...
const SITE_TITLE = "OSIRIS — Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
const SITE_DESCRIPTION = "Track 10,000+ aircraft, 2,000 satellites, and worldwide CCTV cameras in real-time on a 3D globe. Run Nmap scans, DNS lookups, WHOIS queries, SSL cert analysis & threat intelligence — all from your browser. 20+ live data feeds including earthquakes, wildfires, nuclear facilities, cyber threats, and global conflicts. Free & open source.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "OSIRIS — Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "OSIRIS — Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ OSIRIS —  Live Tracking + OSINT Tools",
